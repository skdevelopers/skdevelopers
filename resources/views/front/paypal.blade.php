...
@endsection
@section('script') 
<script src="https://www.paypal.com/sdk/js?client-id=AfL5wpjjXvGb32_2xJshdeGzp3gfXGPuF72taFa0P9TdPHtaFFbtoUUv7OhxMdNegK_b0p8BhKR2OzWq"> // Replace YOUR_SB_CLIENT_ID with your sandbox client ID
    </script>
      ...
      paypal.Buttons({
        ...
        onApprove: function(data) {
          return fetch('/my-server/capture-paypal-transaction', {
            ...
            document.getElementById("response").innerHTML =('Transaction funds captured from ' + details.payer_given_name);
          })
        }
        ...
        //     document.getElementById("response").innerHTML = 'Thank you for making the payment!' + details.payer.name.given_name;
        //   });
        // }
