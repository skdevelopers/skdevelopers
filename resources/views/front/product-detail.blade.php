...
<html lang="en">
  <head>
    ...
    <title>SK Dev - Product Detail</title>
    <!-- Fonts-->
  ...
  <body class="ps-loading">
            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  <div class="ps-product__variants">
                    <div class="item"><img src="{{asset('assets/front/images/shoe-detail/1.jpg')}}" alt=""></div>
                    <div class="item"><img src="{{asset('assets/front/images/shoe-detail/2.jpg')}}" alt=""></div>
                    <div class="item"><img src="{{asset('assets/front/images/shoe-detail/3.jpg')}}" alt=""></div>
                    <div class="item"><img src="{{asset('assets/front/images/shoe-detail/3.jpg')}}" alt=""></div>
                    <div class="item"><img src="{{asset('assets/front/images/shoe-detail/3.jpg')}}" alt=""></div>
                  </div><a class="popup-youtube ps-product__video" href="http://www.youtube.com/watch?v=0O2aH4XLbto"><img src="{{asset('assets/front/images/shoe-detail/1.jpg')}}" alt=""><i class="fa fa-play"></i></a>
                </div>
                <div class="ps-product__image">
                  <div class="item"><img class="zoom" src="{{asset('assets/front/images/shoe-detail/1.jpg')}}" alt="" data-zoom-image="images/shoe-detail/1.jpg')}}"></div>
                  <div class="item"><img class="zoom" src="{{asset('assets/front/images/shoe-detail/2.jpg')}}" alt="" data-zoom-image="images/shoe-detail/2.jpg')}}"></div>
                  <div class="item"><img class="zoom" src="{{asset('assets/front/images/shoe-detail/3.jpg')}}" alt="" data-zoom-image="images/shoe-detail/3.jpg')}}"></div>
                </div>
              </div>
              <div class="ps-product__thumbnail--mobile">
                <div class="ps-product__main-img"><img src="{{asset('assets/front/images/shoe-detail/1.jpg')}}" alt=""></div>
                <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="20" data-owl-nav="true" data-owl-dots="false" data-owl-item="3" data-owl-item-xs="3" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on"><img src="{{asset('assets/front/images/shoe-detail/1.jpg')}}" alt=""><img src="{{asset('assets/front/images/shoe-detail/2.jpg')}}" alt=""><img src="{{asset('assets/front/images/shoe-detail/3.jpg')}}" alt=""></div>
              </div>
              <div class="ps-product__info">
                ...
                <div class="ps-product__block ps-product__style">
                  ...
                  <ul>
                    <li><a href="product-detail.html"><img src="{{asset('assets/front/images/shoe/sidebar/1.jpg')}}" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="{{asset('assets/front/images/shoe/sidebar/2.jpg')}}" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="{{asset('assets/front/images/shoe/sidebar/3.jpg')}}" alt=""></a></li>
                    <li><a href="product-detail.html"><img src="{{asset('assets/front/images/shoe/sidebar/2.jpg')}}" alt=""></a></li>
                  </ul>
                </div>
    ...
    <!-- JS Library-->
    <script type="text/javascript" src="{{asset('assets/front/jquery/dist/jquery.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/jquery-bar-rating/dist/jquery.barrating.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/owl-carousel/owl.carousel.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/gmap3.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/imagesloaded.pkgd.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/isotope.pkgd.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/jquery.matchHeight-min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/slick/slick/slick.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/elevatezoom/jquery.elevatezoom.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/Magnific-Popup/dist/jquery.magnific-popup.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/front/jquery-ui/jquery-ui.min.js')}}"></script>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAx39JFH5nhxze1ZydH-Kl8xXM3OK4fvcg&amp;region=GB"></script><script type="text/javascript" src="{{asset('assets/front/revolution/js/jquery.themepunch.tools.min.js')}}"></script>
